...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial = 0           # Counter for number of trails
    ...
    def build_state(self):
        ...
        state = tuple([waypoint, inputs['light'], inputs['left'], inputs['right'], inputs['oncoming']])
        ...
        if self.learning:
            if state not in self.Q.keys():
                ...
                for action in self.valid_actions:
                    q_actions[action] = 0.0
                self.Q[state] = q_actions
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if random.random() < self.epsilon:
                ...
                best_actions = [key for key in self.Q[state] if self.Q[state][key] == maxq]
